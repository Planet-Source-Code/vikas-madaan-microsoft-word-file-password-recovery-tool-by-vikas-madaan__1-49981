...
NOTE :
	The Project has a Reference to "Microsoft Word 10 Object Library" Please check for that on ur System the Library Version & Make it Correct if VB do not do that.
